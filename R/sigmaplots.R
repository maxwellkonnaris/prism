...
#' @export
sigmaplot <- function(all_inner_results, filename = NULL, save_format = NULL, plot_type = "line") {
  ...
  if (!is.null(save_format)) {
    ggsave(filename = paste0(filename,"Min_Sigma_vs_rho1_", plot_type, ".", save_format), plot = p1_min, width = 10, height = 10, dpi = 300)
    ggsave(filename = paste0(filename,"Max_Sigma_vs_rho1_", plot_type, ".", save_format), plot = p1_max, width = 10, height = 10, dpi = 300)
    ggsave(filename = paste0(filename,"Min_Sigma_vs_rho2_", plot_type, ".", save_format), plot = p2_min, width = 10, height = 10, dpi = 300)
