  ...
  results_list <- foreach(pair = pair_indices, .packages = c('stats', 'MCMCpack'), .options.snow = opts) %dopar% {
      ...
      results_inner <- foreach(s = 1:S, .combine = 'rbind', .packages = c('stats', 'MCMCpack'), .options.snow = opts) %dopar% {
          ...
          data.frame(
            ...
            minsigma_correlation_relativetaxa1_scale = res_min$solution[1][1],
            minsigma_correlation_relativetaxa2_scale = res_min$solution[1][2],
            minsigma_scale_variance = res_min$solution[1][3],
            ...
            maxsigma_correlation_relativetaxa1_scale = res_max$solution[1][1],
            maxsigma_correlation_relativetaxa2_scale = res_max$solution[1][2],
            maxsigma_scale_variance = res_max$solution[1][3],
